...
export function FilePreview({ file, isExpanded, onToggleExpand }: FilePreviewProps) {
  ...
  if (!file || file.type === 'folder') {
    return (
      <div className="bg-gradient-to-br from-pink-50/70 via-rose-50/60 to-orange-50/70 backdrop-blur-sm rounded-xl border border-pink-200 shadow-xl overflow-hidden h-full flex flex-col">
        <div className="bg-gradient-to-r from-pink-100 to-rose-100 px-4 py-3 border-b border-pink-200 flex-shrink-0 flex items-center justify-between relative">
